...
public class XYZ {
    ...
    private static int xyzPopulation = 10000000;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            xyzPopulation += (bornInYear - diedInYear);
            System.out.print("Population after " + year + " year(s): " + xyzPopulation);
